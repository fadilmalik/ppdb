...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href={{asset("landing-page/assets/images/favicon.png")}} type="image/png">

    <!--====== Bootstrap css ======-->
    <link rel="stylesheet" href={{asset("landing-page/assets/css/bootstrap.min.css")}}>

    <!--====== Line Icons css ======-->
    <link rel="stylesheet" href={{asset("landing-page/assets/css/LineIcons.css")}}>
    ...
    <!--====== Default css ======-->
    <link rel="stylesheet" href={{asset("landing-page/assets/css/default.css")}}>
...
<body>
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="page-scroll" href="#home">
                                <h2 style="color: white;">VIRTUAL SCHOOL PPDB</h2>
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarEight">
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll" href="#contact">CUSTOMER SERVICE</a>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="bd-example">
                <div id="carouselOne" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item bg_cover active" style="background-image: url(landing-page/assets/images/slider-1.jpg)">
                            <div class="carousel-caption">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-xl-6 col-lg-7 col-sm-10">
                                            <h2 class="carousel-title">Ilmu Yang Amaliah</h2>
                        ...
                        <div class="carousel-item bg_cover" style="background-image: url(landing-page/assets/images/slider-2.jpg)">
                            <div class="carousel-caption">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-xl-6 col-lg-7 col-sm-10">
                                            <h2 class="carousel-title">Amal Yang Ilmiah</h2>
                                            <ul class="carousel-btn rounded-buttons">
                                                <!-- <li><a class="main-btn rounded-three" href="#">GET STARTED</a></li> -->
                                                <li><a class="main-btn rounded-one" href="#">DAFTAR SEKARANG</a></li>
                                            </ul>
                        ...
                        <div class="carousel-item bg_cover" style="background-image: url(landing-page/assets/images/slider-3.jpg)">
                            <div class="carousel-caption">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <div class="col-xl-6 col-lg-7 col-sm-10">
                                            <h2 class="carousel-title">Akhlakul Karimah</h2>
                                            <ul class="carousel-btn rounded-buttons">
                                                <!-- <li><a class="main-btn rounded-three" href="#">GET STARTED</a></li> -->
                                                <li><a class="main-btn rounded-one" href="#">DAFTAR SEKARANG</a></li>
                                            </ul>
    ...
    <div class="sidebar-right">
        ...
        <div class="sidebar-content">
            <div class="sidebar-logo text-center">
                <a href="#"><img src={{asset("landing-page/assets/images/logo-alt.png")}} alt="Logo"></a>
            </div> <!-- logo -->
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8">
                    <div class="about-image text-center wow fadeInUp" data-wow-duration="1.5s" data-wow-offset="100">
                        <img src={{asset("landing-page/assets/images/services.png")}} alt="services">
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.2s">
                        <div class="about-icon">
                            <img src={{asset("landing-page/assets/images/icon-1.png")}} alt="Icon">
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.4s">
                        <div class="about-icon">
                            <img src={{asset("landing-page/assets/images/icon-2.png")}} alt="Icon">
                        </div>
                        <div class="about-content media-body">
                ...
                <div class="col-lg-6">
                    <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.6s">
                        <div class="about-icon">
                            <img src={{asset("landing-page/assets/images/icon-3.png")}} alt="Icon">
                        </div>
                        <div class="about-content media-body">
                ...
                <div class="col-lg-6">
                    <div class="single-about d-sm-flex mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1.8s">
                        <div class="about-icon">
                            <img src={{asset("landing-page/assets/images/icon-4.png")}} alt="Icon">
                        </div>
                        <div class="about-content media-body">
            ...
            <div class="row grid">
                <div class="col-lg-4 col-sm-6 branding-3 planning-3">
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
                        <div class="portfolio-image">
                            <img src={{asset("landing-page/assets/images/portfolio-1.png")}} alt="">
                            <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                <div class="portfolio-content">
                                    <div class="portfolio-icon">
                                        <a class="image-popup" href={{asset("landing-page/assets/images/portfolio-1.png")}}><i class="lni-zoom-in"></i></a>
                                    </div>
                                    <div class="portfolio-icon">
                ...
                <div class="col-lg-4 col-sm-6 marketing-3 research-3">
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                        <div class="portfolio-image">
                            <img src={{asset("landing-page/assets/images/portfolio-2.png")}} alt="">
                            <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                <div class="portfolio-content">
                                    <div class="portfolio-icon">
                                        <a class="image-popup" href={{asset("landing-page/assets/images/portfolio-2.png")}}><i class="lni-zoom-in"></i></a>
                                    </div>
                                    <div class="portfolio-icon">
                                        <a href="#"><i class="lni-link"></i></a>
                                    </div>
                ...
                <div class="col-lg-4 col-sm-6 branding-3 marketing-3">
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.7s">
                        <div class="portfolio-image">
                            <img src={{asset("landing-page/assets/images/portfolio-3.png")}} alt="">
                            <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                <div class="portfolio-content">
                                    <div class="portfolio-icon">
                                        <a class="image-popup" href={{asset("landing-page/assets/images/portfolio-3.png")}}><i class="lni-zoom-in"></i></a>
                                    </div>
                                    <div class="portfolio-icon">
                                        <a href="#"><i class="lni-link"></i></a>
                                    </div>
                ...
                <div class="col-lg-4 col-sm-6 planning-3 research-3">
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.2s">
                        <div class="portfolio-image">
                            <img src={{asset("landing-page/assets/images/portfolio-4.png")}} alt="">
                            <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                <div class="portfolio-content">
                                    <div class="portfolio-icon">
                                        <a class="image-popup" href={{asset("landing-page/assets/images/portfolio-4.png")}}><i class="lni-zoom-in"></i></a>
                                    </div>
                                    <div class="portfolio-icon">
                                        <a href="#"><i class="lni-link"></i></a>
                                    </div>
                ...
                <div class="col-lg-4 col-sm-6 marketing-3">
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                        <div class="portfolio-image">
                            <img src={{asset("landing-page/assets/images/portfolio-5.png")}} alt="">
                            <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                <div class="portfolio-content">
                                    <div class="portfolio-icon">
                                        <a class="image-popup" href={{asset("landing-page/assets/images/portfolio-5.png")}}><i class="lni-zoom-in"></i></a>
                                    </div>
                                    <div class="portfolio-icon">
                                        <a href="#"><i class="lni-link"></i></a>
                                    </div>
                ...
                <div class="col-lg-4 col-sm-6 planning-3">
                    <div class="single-portfolio mt-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.7s">
                        <div class="portfolio-image">
                            <img src={{asset("landing-page/assets/images/portfolio-6.png")}} alt="">
                            <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                <div class="portfolio-content">
                                    <div class="portfolio-icon">
                                        <a class="image-popup" href={{asset("landing-page/assets/images/portfolio-6.png")}}><i class="lni-zoom-in"></i></a>
                                    </div>
                                    <div class="portfolio-icon">
                                        <a href="#"><i class="lni-link"></i></a>
                                    </div>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="pricing-style-one mt-40 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.2s">
                        <div class="pricing-icon text-center">
                            <img src={{asset("landing-page/assets/images/wman.svg")}} alt="">
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="row testimonial-active">
                        <div class="col-lg-4">
                            <div class="single-testimonial mt-30 mb-30 text-center">
                                <div class="testimonial-image">
                                    <img src={{asset("landing-page/assets/images/author-3.jpg")}} alt="Author">
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="single-testimonial mt-30 mb-30 text-center">
                                <div class="testimonial-image">
                                    <img src={{asset("landing-page/assets/images/author-1.jpg")}} alt="Author">
                                </div>
                                <div class="testimonial-content">
                                    <p class="text">Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed! Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed!</p>
                        ...
                        <div class="col-lg-4">
                            <div class="single-testimonial mt-30 mb-30 text-center">
                                <div class="testimonial-image">
                                    <img src={{asset("landing-page/assets/images/author-2.jpg")}} alt="Author">
                                </div>
                                <div class="testimonial-content">
                                    <p class="text">Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed! Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed!</p>
                        ...
                        <div class="col-lg-4">
                            <div class="single-testimonial mt-30 mb-30 text-center">
                                <div class="testimonial-image">
                                    <img src={{asset("landing-page/assets/images/author-4.jpg")}} alt="Author">
                                </div>
                                <div class="testimonial-content">
                                    <p class="text">Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed! Stop wasting time and money designing and managing a website that doesn’t get results. Happiness guaranteed!</p>
            ...
            <div class="row client-active">
                <div class="col-lg-3">
                    <div class="single-client text-center">
                        <img src={{asset("landing-page/assets/images/client_logo_01.png")}} alt="Logo">
                    </div> <!-- single client -->
                </div>
                <div class="col-lg-3">
                    <div class="single-client text-center">
                        <img src={{asset("landing-page/assets/images/client_logo_02.png")}} alt="Logo">
                    </div> <!-- single client -->
                </div>
                <div class="col-lg-3">
                    <div class="single-client text-center">
                        <img src={{asset("landing-page/assets/images/client_logo_03.png")}} alt="Logo">
                    </div> <!-- single client -->
                </div>
                <div class="col-lg-3">
                    <div class="single-client text-center">
                        <img src={{asset("landing-page/assets/images/client_logo_04.png")}} alt="Logo">
                    </div> <!-- single client -->
                </div>
                <div class="col-lg-3">
                    <div class="single-client text-center">
                        <img src={{asset("landing-page/assets/images/client_logo_05.png")}} alt="Logo">
                    </div> <!-- single client -->
                </div>
                <div class="col-lg-3">
                    <div class="single-client text-center">
                        <img src={{asset("landing-page/assets/images/client_logo_06.png")}} alt="Logo">
                    </div> <!-- single client -->
                </div>
                <div class="col-lg-3">
                    <div class="single-client text-center">
                        <img src={{asset("landing-page/assets/images/client_logo_07.png")}} alt="Logo">
                    </div> <!-- single client -->
                </div>
                <div class="col-lg-3">
                    <div class="single-client text-center">
                        <img src={{asset("landing-page/assets/images/client_logo_08.png")}} alt="Logo">
                    </div> <!-- single client -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-2">
                        <div class="footer-logo text-center mt-10">
                            <a href="index.html"><img src={{asset("landing-page/assets/images/logo-2.svg")}} alt="Logo"></a>
                        </div> <!-- footer logo -->
                    </div>
                    <div class="col-lg-5">
    ...
    <!--====== jquery js ======-->
    <script src={{asset("landing-page/assets/js/vendor/modernizr-3.6.0.min.js")}}></script>
    ...
    <!--====== Isotope js ======-->
    <script src={{asset("landing-page/assets/js/isotope.pkgd.min.js")}}></script>

    <!--====== Images Loaded js ======-->
    <script src={{asset("landing-page/assets/js/imagesloaded.pkgd.min.js")}}></script>

    <!--====== Magnific Popup js ======-->
    <script src={{asset("landing-page/assets/js/jquery.magnific-popup.min.js")}}></script>

    <!--====== Scrolling js ======-->
    <script src={{asset("landing-page/assets/js/scrolling-nav.js")}}></script>
    <script src={{asset("landing-page/assets/js/jquery.easing.min.js")}}></script>
